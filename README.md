# SD Laboratorio 3
 Laboratorio 3, Sistemas Distribuido
...
### Instalación
Cada nodo es contenido en su propio Container Docker. Se disponen los siguientes comandos en una terminal alocado en la raiz del proyecto:
...
Para cambiar el archivo de entrada del producto, esta la variable de entorno `INPUT_FILE`.
